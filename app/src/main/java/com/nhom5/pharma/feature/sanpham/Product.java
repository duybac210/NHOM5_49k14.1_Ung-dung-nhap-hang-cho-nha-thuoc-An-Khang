...
public class Product {
    ...
    public String getDisplayId() { return id; }
    ...
    public static long extractProductNumber(String rawId) {
        ...
        try {
            ...
            if (numberText == null || numberText.isEmpty()) return -1;
        ...
        if (documents != null) {
            for (DocumentSnapshot document : documents) {
                ...
                for (String candidate : candidates) {
                    if (candidate == null || candidate.trim().isEmpty() || isLegacyBadProductId(candidate)) continue;
